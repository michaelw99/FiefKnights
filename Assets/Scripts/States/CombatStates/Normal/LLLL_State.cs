...
public class LLLL_State : GroundedState
{
    float ATK_MOVE = 0.3f;
    ...
    public override void update(PlayerController player)
    {
        ...
        if (stateTime >= hitboxStart && !hitboxHasSpawned)
        {
            ...
            if (player.isFacingRight)
            {
                ...
                player.spawnHitbox(Resources.Load("NormalHitBoxes/LLLL_HitBox"), spawnPoint, player.gameObject.transform.rotation, hitboxDuration);
